function displayQuote() {
  var quotes = [
    ...
    ["Never put passion in front of principle, even if you win, you’ll lose.", " –  Mr. Miyagi, The Karate Kid"],
    ["It’s ok to lose to opponent. It’s never okay to lose to fear.", " –  Mr. Miyagi, The Karate Kid"],
    ["No such thing as bad student, only bad teacher. Teacher say, student do.", " –  Mr. Miyagi, The Karate Kid"],
...
$(document).ready(function() {
  displayQuote();
  scrollToSection('#work', '#timeline-container')
});
